...
<head>
    ...
    <script>
        function onSubmitClick(){
            ...
            xmlhttp.onreadystatechange=function(){
                if(xmlhttp.readyState==4&&xmlhttp.status==200){
                    ...
                    if(result=="success"){
                        ...
                        window.location.href="../question/showquestion";
                    }else{
            ...
            xmlhttp.open("post","../student/dologin");
            xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
            var name=document.getElementById("name").value;
            var password=document.getElementById("password").value;
            xmlhttp.send("stuname="+name+"&password="+password);
...
<center>
    ...
    <div>
        <form id="form" action="#" method="post" >
            <input id="name" name="name" placeholder="用户名" value="zhangsan"/><br>
            <input id="password" type="password" placeholder="密码" name="password" value="123456"/><br>
