...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductPage getPage(int pageNo, int pageSize, String category) {
       ...
       /* long a=productDao.selectProdductCount()/pageSize+productDao.selectProdductCount()%pageSize==0?0:1;
        productPage.setPageCount(a);*/
        productPage.setPageCount((long)Math.ceil(1.0*productDao.selectProdductCount(category)/pageSize));
