...
<head>
    ...
    <script>
        function onSubmitClick(){
            ...
            xmlhttp.open("post","../user/dologin");
            xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
            var logininfo=document.getElementById("logininfo").value;
            var password=document.getElementById("password").value;
            xmlhttp.send("logininfo="+logininfo+"&password="+password);
...
<center>
    ...
    <div>
        <form id="form" action="#" method="post" >
            <input id="logininfo" name="logininfo" placeholder="用户名/邮箱/手机号" value="zhangsan"/><br>
